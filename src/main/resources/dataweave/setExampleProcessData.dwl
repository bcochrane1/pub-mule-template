...
//this information gets mapped into vars.runData in the initialize-process-dataFlow
---
{
	...
	"processDescription": Mule::p('process.main.description') default defaultMessage,
